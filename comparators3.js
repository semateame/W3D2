...
employees1.sort(salaryComparator);



let employees2= [
    new Employee("George", 40000,new Date(1996, 11, 5)),
    new Employee("Dave", 50000, new Date(2000, 1, 3)),
    new Employee("Richard", 45000, new Date(2001, 2, 7))]
...
employees2.sort(hiredDateComparator);